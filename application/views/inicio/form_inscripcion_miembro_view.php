	...
	<div class="row" id="container" style="margin-left: 7px;">
		...
		<?php echo form_open('inicio/recibe_datos_frm_registro'); ?>
			...
			<thead>
				...
				<tbody>
				<tr>
				<td colspan="2"><h3>Información del nuevo distribuidor</h3></td>
				</tr>
					<tr id="main_info_tr">
		        		<td>
		        	...
		        	<tr>
		        		<td>
		        			<label for="patrocinador" style="color: red;">Cédula del Patrocinador:</label>
		        			<br>
		        		...
		        		<td>
		        			...
		        			<br>
							<label id="codigo_patrocinador_inf" style="margin-right: 10px;"></label>
		        	...
		        	<tr id="tr_1" style="display:none;">
		        		<td><label style="text-align: center;">Ubicación en la red binaria</label></td><td></td>
		        	</tr>
		        	<tr id="tr_2" style="display:none;">
		        		<td>
		        			<label for="padre">Padre:</label>
		        			<br>
		        			<select id="padre" name="padre" class="form-control info_patrocinador" required="required"></select>
		        		</td>
		        		<td>
		        			<label for="rama">Rama:</label>
		        			<br>
		        			<input type="radio" name="rama" value="1"> Izquierda
		        			<br>
		        			<input type="radio" name="rama" value="2"> Derecha
		        		</td>
		        	</tr>
		        	<tr>
		        		<td>
