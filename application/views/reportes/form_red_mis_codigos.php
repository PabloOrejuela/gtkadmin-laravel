...
<table class="table table-bordered" id="table_datos">
	<thead>
		<tr><td colspan="2"><strong>Codigos Activos: </strong> Escoja cual de sus códigos desea consultar</td></tr>
		<tr>
		...
		if($codigos_binarios != NULL){
			foreach ($codigos_binarios as $key => $value) {
				...
				<td style="text-align: center; width: 50px;">';
					...
					echo '<button type="submit" class="btn btn-primary">Resumen Financiero</button>';
					echo form_close();
				echo '</td>';
